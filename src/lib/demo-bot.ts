...
// The built-in demo bot embedded on our own landing page (botKey "demo").
// It sells KayCreatesWeb — dogfooding the widget. Its conversations and leads
...
export const DEMO_WORKSPACE: Workspace = {
  ...
  userId: "demo",
  name: "KayCreatesWeb",
  website: "https://kaycreatesweb.com",
  about:
    "KayCreatesWeb gives any business an AI chatbot for their website plus an AI SEO studio. The chatbot answers visitor questions 24/7 and captures leads; the SEO studio audits pages, scores them, and writes titles, meta descriptions, keywords, and blog posts.",
  plan: "scale",
...
export const DEMO_BOT: Bot = {
  ...
  goal: "leads",
  welcome:
    "Hey! 👋 I'm Kay — the exact widget you'd get for your own site. Ask me anything about KayCreatesWeb, or just test how I handle a real visitor.",
  knowledge: `Product: KayCreatesWeb — AI chatbots & SEO for any website.
...
Setup: sign up, describe your business, paste one script tag into your site — live in under 5 minutes. Works with any website platform (WordPress, Shopify, Squarespace, Wix, custom).`,
  faq: [
    {
      q: "How do I install the chatbot on my website?",
      a: "One script tag — we give it to you after signup. Paste it before </body> on any platform (WordPress, Shopify, Squarespace, Wix, custom code) and the chat bubble appears instantly.",
    },
    {
