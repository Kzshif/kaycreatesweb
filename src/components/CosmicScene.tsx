    ...
    <div className="cosmic-scene pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      ...
      <div className="scene-bob absolute -right-16 top-[16%] opacity-70 sm:right-[4%]">
        <svg width="180" height="180" viewBox="0 0 200 200">
          ...
          <ellipse cx="100" cy="104" rx="88" ry="20" fill="none" stroke="#ffb454" strokeOpacity="0.35" strokeWidth="3" />
          <circle cx="100" cy="100" r="52" fill="url(#planetG)" />
          <circle cx="82" cy="86" r="9" fill="#ffffff" opacity="0.12" />
          <circle cx="116" cy="112" r="6" fill="#08061a" opacity="0.25" />
          <circle cx="104" cy="78" r="4" fill="#08061a" opacity="0.2" />
          <ellipse cx="100" cy="104" rx="88" ry="20" fill="none" stroke="#f06595" strokeOpacity="0.35" strokeWidth="2" strokeDasharray="6 10" />
        </svg>
      </div>
        ...
        <div className="scene-rocket">
          <svg width="64" height="64" viewBox="0 0 64 64">
            <g transform="rotate(90 32 32)">
              ...
              <circle cx="32" cy="26" r="5" fill="#3bc9db" stroke="#1a1735" strokeWidth="2" />
              <path d="M24 34 L16 46 L24 44 Z" fill="#f06595" />
              <path d="M40 34 L48 46 L40 44 Z" fill="#f06595" />
              <path d="M28 40 L32 54 L36 40 Z" fill="#ffb454" className="scene-flame" />
            </g>
          </svg>
        </div>
      </div>
      ...
      <div className="scene-astro absolute left-[6%] top-[58%] opacity-80">
        <svg width="56" height="56" viewBox="0 0 64 64">
          <g transform="rotate(-14 32 32)">
            ...
            <circle cx="32" cy="20" r="8" fill="#1a1735" />
            <circle cx="30" cy="18" r="2.5" fill="#3bc9db" opacity="0.9" />
            ...
            <path d="M22 34 C12 30 10 22 16 16" stroke="#f06595" strokeWidth="1.6" fill="none" strokeDasharray="3 4" opacity="0.8" />
          </g>
        </svg>
      </div>
      ...
      <div className="scene-sat absolute right-[-6%] top-[10%] opacity-70">
        <svg width="44" height="44" viewBox="0 0 48 48">
          ...
          <rect x="4" y="21" width="13" height="6" rx="1" fill="#3bc9db" opacity="0.85" />
          <rect x="31" y="21" width="13" height="6" rx="1" fill="#3bc9db" opacity="0.85" />
          <circle cx="24" cy="14" r="2.4" fill="#ffb454" className="scene-blink" />
        </svg>
      </div>
    </div>
  );
