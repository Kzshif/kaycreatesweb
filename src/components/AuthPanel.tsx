...
export function AuthPanel({
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-[1fr_1.1fr]">
      {/* Brand panel */}
      <aside className="relative hidden overflow-hidden bg-space p-10 text-starlight lg:flex lg:flex-col lg:justify-between">
        <Starfield seed={4242} density={260} opacity={0.85} />
        <div
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-4 text-sm leading-relaxed text-starlight/60">
        ...
        <ul className="relative space-y-2.5 text-sm text-starlight/70">
      ...
      <main className="flex items-center justify-center px-5 py-12 sm:px-10">
        <div className="w-full max-w-md">
          ...
          <p className="mt-10 text-center text-xs text-ink/35">
            <Link href="/" className="transition hover:text-ink/60">← Back to mission control</Link>
          </p>
        </div>
      </main>
    </div>
